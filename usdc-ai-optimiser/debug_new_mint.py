#!/usr/bin/env python3
"""Debug the new mint transaction"""
...
def debug_new_mint():
    ...
    print(f"🔑 Debugging new mint for wallet: {account.address}")
    
    print("\n🔍 DEBUGGING NEW MINT TRANSACTION")
    print("=" * 50)
    
    # Initialize CCTP
    cctp = CCTPIntegration()
    
    # The new mint transaction hash
    mint_tx_hash = "9f3740ba7d091cd6d525bc87782c04bc958f4c0eaa7451020235bb72caff17e3"
    ...
    try:
        ...
        for i, log in enumerate(receipt.logs):
            ...
            if log.address.lower() == config.usdc_address.lower():
                ...
                # Check if this is a mint event (Transfer from 0x0)
                if len(log.topics) >= 3:
