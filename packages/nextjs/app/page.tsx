...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-base-100">
      {/* Navigation */}
      <nav className="border-b border-base-300 bg-base-100/95 backdrop-blur supports-[backdrop-filter]:bg-base-100/60">
      ...
      <section className="relative overflow-hidden py-24 sm:py-32">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-base-content/70 text-pretty max-w-2xl mx-auto">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            <div className="text-center">
              ...
              <div className="text-sm text-base-content/70">Max APY (Aggressive)</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-primary">10/10</div>
              <div className="text-sm text-base-content/70">System Health</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-primary">3</div>
              <div className="text-sm text-base-content/70">AI Agents</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-primary">0ms</div>
              <div className="text-sm text-base-content/70">CCTP Slippage</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="architecture" className="py-24 bg-base-200">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center mb-16">
      ...
      <section id="integrations" className="py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center mb-16">
            ...
            <p className="mt-4 text-lg text-base-content/70">Built on industry-leading protocols and infrastructure</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-4">
            {[
              ...
              <div
                key={integration}
                className="flex items-center justify-center p-4 bg-base-100 rounded-lg border border-base-300 hover:border-primary/20 transition-colors"
              >
                <span className="text-sm font-medium text-base-content/70 text-center">{integration}</span>
              </div>
            ))}
          </div>
        </div>
