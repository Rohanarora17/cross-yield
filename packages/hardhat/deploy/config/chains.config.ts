/**
 * Chain configuration for CrossYield multi-chain deployment
 */
...
export const CHAIN_CONFIGS: { [key: string]: ChainConfig } = {
    ...
    protocols: {
      aave_v3: {
        ...
        addresses: {
          ...
          aToken: "0x94a9D9AC8a22534E3FaCa9F4e7F2E2cf85d5E4C8",
        },
        riskScore: 15,
      },
      compound_v3: {
  ...
  base_sepolia: {
    ...
    protocols: {
      moonwell: {
        name: "Moonwell",
        addresses: {
          comptroller: "0xfBb7d83aC3BAEEf4618BE10d13c9fA1fd5bAFa65",
          cToken: "0x2Ae3F1Ec7F1F5012CFEab0185bfc7aa3cf0DEc22",
        },
        riskScore: 25,
      },
      uniswap_v3: {
    ...
    protocols: {
      radiant: {
        ...
        addresses: {
          ...
          rToken: "0x48a29E756CC1C097388f3B2f3b570ED270423b3d",
        },
        riskScore: 35,
      },
      camelot: {
        ...
        addresses: {
          ...
          factory: "0x6EcCab422D763aC031210895C81787E87B91425a",
        },
        riskScore: 40,
      },
    },
  ...
  ethereum: {
    ...
    usdcAddress: "0xA0b86a33E6417c33b2F2e5d8A7C0C5a3C0F9E2B3", // USDC on Ethereum
    cctpDomain: 0,
    isTestnet: false,
...
export const TESTNET_CHAINS = ["ethereum_sepolia", "base_sepolia", "arbitrum_sepolia"];
export const MAINNET_CHAINS = ["ethereum", "base", "arbitrum"];
...
export function isTestnet(chainName: string): boolean {
  return TESTNET_CHAINS.includes(chainName);
}

export function getDeploymentChains(useTestnet: boolean = true): string[] {
